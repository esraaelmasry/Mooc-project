...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post lectures_url, params: { lecture: { attatchment: @lecture.attatchment, content: @lecture.content, course_id: @lecture.course_id } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { attatchment: @lecture.attatchment, content: @lecture.content, course_id: @lecture.course_id } }
